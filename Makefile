LIB_OBJS1 = pa_datetime.o pa_coordinates.o pa_sun.o pa_planet.o pa_comet.o pa_binary.o
LIB_OBJS2 = pa_data.o pa_macros.o pa_util.o 
TEST_OBJS = test.o test_datetime.o test_coordinates.o test_sun.o test_planet.o test_comet.o test_binary.o
...
pa_binary.o: lib/pa_binary.cpp lib/pa_binary.h $(SUPPORT_HEADERS)
	$(COMPILER) -std=$(CPP_STD) -c lib/pa_binary.cpp
